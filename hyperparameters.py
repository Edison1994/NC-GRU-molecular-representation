...
def add_arguments(parser):
    ...
    parser.add_argument('--input_sequence_key', default="canonical_smiles", type=str)
    ...
    parser.add_argument('-c', '--cell_size',
                        ...
                        default=[160, 320, 640],
                        type=int)
    parser.add_argument('--nono', help='number of negative ones in NC-GRU cells',
                        nargs='+',
                        default=[40, 80, 160],
                        type=int)
    parser.add_argument('-e', '--emb_size', help='size of bottleneck layer', default=512, type=int)
    parser.add_argument('-l', '--learning_rate', default=0.001, type=float)
    # parser.add_argument('-A_l', '--A_learning_rate', default=1e-4, type=float)
    ...
    parser.add_argument('-n', '--num_steps', help="number of train steps", default=100000, type=int)
    ...
    parser.add_argument('--one_hot_embedding', default=True, type=bool)
    ...
    parser.add_argument('-ks', '--kernel_size', nargs='+', default=[5], type=int)
    ...
    # parser.add_argument('--enrnn_size', help='', nargs='+', default=[40, 80, 160], type=int)
